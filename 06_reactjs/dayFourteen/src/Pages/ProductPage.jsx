...
import { addToCart, incrementQty, decrementQty } from "../redux/slice/CartSlice";
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
                ...
                <div class="flex space-x-4 mb-6">
                    <button onClick={()=>dispatch(addToCart(data))} class="flex-1 bg-blue-600 text-white py-3 px-6 rounded-lg font-semibold hover:bg-blue-700 transition-colors">
                        Add to Cart
                    </button>
