        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
                <div class="mb-4">
                    <img id="mainImage" src="https://images.pexels.com/photos/3394650/pexels-photo-3394650.jpeg?auto=compress&cs=tinysrgb&w=800" 
                         alt="Product Image" class="w-full h-96 object-cover rounded-lg" />
                </div>
            ...
            <div>
                ...
                <div class="flex items-center mb-4">
                    ...
                    <span class="text-gray-600 ml-2">(124 reviews)</span>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <p class="text-gray-600">Experience premium sound quality with our wireless headphones featuring advanced noise cancellation technology. Perfect for music lovers and professionals who demand the best audio experience.</p>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="flex items-center space-x-3">
                        <button class="w-10 h-10 border border-gray-300 rounded-lg flex items-center justify-center hover:bg-gray-50" onclick="decreaseQuantity()">
                            <i data-lucide="minus" class="w-4 h-4"></i>
                        </button>
                        <span id="quantity" class="text-xl font-semibold">1</span>
                        <button class="w-10 h-10 border border-gray-300 rounded-lg flex items-center justify-center hover:bg-gray-50" onclick="increaseQuantity()">
        ...
        <div class="mt-16">
            <div class="border-b border-gray-200">
                <nav class="-mb-px flex space-x-8">
                    <button class="tab-button active py-2 px-1 border-b-2 border-blue-500 font-medium text-sm text-blue-600" onclick="showTab('description')">
                        Description
                    </button>
                    <button class="tab-button py-2 px-1 border-b-2 border-transparent font-medium text-sm text-gray-500 hover:text-gray-700 hover:border-gray-300" onclick="showTab('specifications')">
                        Specifications
                    </button>
